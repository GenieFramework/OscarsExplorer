...
# !!! Main.UserApp is configured as an alias for Main.OscarStats and you might encounter it in some tests
using Main.OscarStats, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "OscarStats tests" begin
  @includetests ARGS
end
